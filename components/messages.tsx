...
const mockMessages = [
  {
    ...
    lastMessage: "Your application has been approved! We would like to schedule your first visit.",
  ...
  },
  {
    ...
    trial: "General",
    lastMessage: "Welcome to CuraLink! We are excited to have you on board.",
    timestamp: "1 day ago",
    unread: false,
    avatar: "🤖",
  },
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-foreground/70">Stay connected with researchers and support staff</p>
      </div>
